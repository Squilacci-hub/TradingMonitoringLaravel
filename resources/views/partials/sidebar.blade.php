<nav class="sidebar">
    ...
    <a href="{{ route('trades.create') }}" class="nav-item {{ Request::is('trades/create') ? 'active' : '' }}">
        <div class="nav-icon"><i class="fa-solid fa-plus-circle" style="color: var(--accent-blue);"></i></div>
    ...
    <form action="{{ route('logout') }}" method="POST" style="width: 100%;">
        ...
        <button type="submit" class="nav-item"
            style="background: none; border: none; cursor: pointer; color: inherit; font-family: inherit; width: 100%; text-align: left;">
            <div class="nav-icon"><i class="fa-solid fa-right-from-bracket" style="color: var(--accent-crimson);"></i>
            </div>
